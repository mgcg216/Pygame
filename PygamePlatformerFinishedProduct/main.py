...
class Game:
    ...
    def load_data(self):
        ...
        self.boost_sound = pg.mixer.Sound(path.join(self.snd_dir, 'smb_1-up.wav'))
            ...
            if hits:
                ...
                for hit in hits:
                    if hit.rect.bottom > lowest.rect.bottom:
                        lowest = hit
                if self.player.pos.x < lowest.rect.right and self.player.pos.x + 10 > lowest.rect.left - 10:
